import{u as j,a as M,j as t,T as h,L as i,g as B,b as D,S}from"./index-P8zfGJez.js";import{s as v,b as T,d as E,q as N}from"./lucide-Co6CbEbm.js";const p=[{id:"viktminskningskalkylator-guide",title:"Viktminskningskalkylator: sätta kalorimål för hållbar viktnedgång",description:"Så funkar en viktminskningskalkylator, hur stort kaloriunderskott som är rimligt och hur du använder resultatet i vardagen.",date:"2026-05-12",readTime:"7 min",category:"Hälsa",image:"https://images.unsplash.com/photo-1498837167922-ddd27525d352?auto=format&fit=crop&q=80&w=800",link:"/blog/viktminskningskalkylator-guide",author:"Pontus",content:`
    ...
    `},{id:"bmrkalkylator-guide",title:"BMR-kalkylator: så får du fram din basalmetabolism",description:"En enkel guide till vad BMR betyder, hur uträkningen fungerar och hur du använder BMR-kalkylatorn för att få ett bra startvärde.",date:"2026-05-09",readTime:"6 min",category:"Hälsa",image:"https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&q=80&w=800",link:"/blog/bmrkalkylator-guide",author:"Pontus",content:`
    ...
    `}],R=d=>Array.from(d.matchAll(/href="(\/[^"]+)"/g)).map(k=>k[1]),I=()=>{const{id:d}=j(),{getVisibleCalculators:k}=M(),r=p.find(a=>a.id===d);if(!r)return t.jsxs("div",{className:"min-h-screen bg-gray-50",children:[t.jsx(h,{currentPage:"blog"}),t.jsx("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:t.jsxs("div",{className:"text-center",children:[t.jsx("h1",{className:"text-2xl font-bold text-gray-900 mb-4",children:"Bloggpost hittades inte"}),t.jsx("p",{className:"text-gray-600 mb-8",children:"Den bloggpost du letar efter finns inte."}),t.jsxs(i,{to:"/blog",className:"inline-flex items-center text-indigo-600 hover:text-indigo-500",children:[t.jsx(v,{className:"w-4 h-4 mr-2"}),"Tillbaka till bloggen"]})]})})]});const s=`https://www.kalkylatorn.com${r.link}`,g=k(),m=new Map(g.map(a=>[a.path,a])),f=B(r.id).filter(a=>m.has(a)),c=Array.from(new Set(R(r.content).filter(a=>m.has(a)))),o=Array.from(new Set([...f,...c])),b=[...o.map(a=>m.get(a)).filter(a=>!!a),...g.filter(a=>!o.includes(a.path)&&a.category===r.category),...g.filter(a=>!o.includes(a.path)&&a.category!==r.category)].slice(0,4),u=Array.from(new Map(o.flatMap(a=>D(a)).filter(a=>a.id!==r.id).map(a=>[a.id,a])).values()),y=[...u.map(a=>p.find(e=>e.id===a.id)).filter(a=>!!a),...p.filter(a=>a.id!==r.id).filter(a=>!u.some(e=>e.id===a.id)).sort((a,e)=>{const n=a.category===r.category?1:0,l=e.category===r.category?1:0;return n!==l?l-n:new Date(e.date).getTime()-new Date(a.date).getTime()})].sort((a,e)=>{const n=a.category===r.category?1:0,l=e.category===r.category?1:0;return n!==l?l-n:new Date(e.date).getTime()-new Date(a.date).getTime()}).slice(0,3),x={"@context":"https://schema.org","@graph":[{"@type":"Article",headline:r.title,description:r.description,image:r.image,datePublished:r.date,dateModified:r.date,inLanguage:"sv-SE",author:{"@type":"Person",name:r.author},publisher:{"@type":"Organization",name:"Kalkylatorn.com",url:"https://www.kalkylatorn.com"},mainEntityOfPage:{"@type":"WebPage","@id":s},url:s},{"@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"Hem",item:"https://www.kalkylatorn.com/"},{"@type":"ListItem",position:2,name:"Blogg",item:"https://www.kalkylatorn.com/blog"},{"@type":"ListItem",position:3,name:r.title,item:s}]}]};return t.jsxs("div",{className:"min-h-screen bg-gray-50",children:[t.jsx(S,{title:r.title,description:r.description,canonicalUrl:s,type:"article",imageUrl:r.image,schema:x}),t.jsx(h,{currentPage:"blog"}),t.jsxs("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[t.jsxs(i,{to:"/blog",className:"inline-flex items-center text-gray-600 hover:text-gray-900 mb-8",children:[t.jsx(v,{className:"w-5 h-5 mr-2"}),"Tillbaka till bloggen"]}),t.jsxs("header",{className:"mb-8",children:[t.jsxs("div",{className:"flex items-center text-sm text-gray-500 mb-4",children:[t.jsx(T,{className:"w-4 h-4 mr-1"}),t.jsx("time",{dateTime:r.date,children:new Date(r.date).toLocaleDateString("sv-SE")}),t.jsx("span",{className:"mx-2",children:"•"}),t.jsx(E,{className:"w-4 h-4 mr-1"}),t.jsx("span",{children:r.readTime}),t.jsx("span",{className:"mx-2",children:"•"}),t.jsxs("span",{children:["Av ",r.author]})]}),t.jsx("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:r.title}),t.jsx("p",{className:"text-xl text-gray-600 mb-6",children:r.description}),t.jsx("div",{className:"flex items-center justify-between",children:t.jsx("span",{className:"inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800",children:r.category})})]}),t.jsx("div",{className:"mb-8",children:t.jsx("img",{src:r.image,alt:r.title,width:800,height:533,fetchPriority:"high",decoding:"async",className:"w-full h-64 md:h-96 object-cover rounded-2xl shadow-lg"})}),t.jsx("article",{className:"max-w-none blog-content",children:t.jsx("div",{dangerouslySetInnerHTML:{__html:r.content},className:"text-gray-700 leading-relaxed"})}),t.jsxs("section",{className:"mt-12 rounded-2xl border border-gray-200 bg-transparent p-6",children:[t.jsx("h2",{className:"text-xl font-bold text-gray-900",children:"Relaterade kalkylatorer"}),t.jsx("p",{className:"mt-2 text-gray-600",children:"Testa fler verktyg som hjälper dig att räkna vidare på samma tema."}),t.jsx("div",{className:"mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2",children:b.map(a=>t.jsx(i,{to:a.path,className:"rounded-lg border border-indigo-200 bg-white px-4 py-3 text-sm font-medium text-indigo-700 transition-colors hover:bg-indigo-100",children:a.title},a.id))})]}),t.jsxs("section",{className:"mt-8 rounded-2xl border border-gray-200 bg-white p-6",children:[t.jsx("h2",{className:"text-xl font-bold text-gray-900",children:"Relaterade inlägg"}),t.jsx("div",{className:"mt-4 space-y-3",children:y.map(a=>t.jsxs(i,{to:a.link,className:"block rounded-lg border border-gray-200 p-4 transition-colors hover:border-indigo-200 hover:bg-indigo-50",children:[t.jsx("p",{className:"text-sm text-indigo-700",children:a.category}),t.jsx("p",{className:"mt-1 font-semibold text-gray-900",children:a.title})]},a.id))})]}),t.jsx("div",{className:"mt-12 pt-8 border-t border-gray-200",children:t.jsxs("div",{className:"flex items-center",children:[t.jsx("div",{className:"w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center",children:t.jsx(N,{className:"w-6 h-6 text-indigo-600"})}),t.jsxs("div",{className:"ml-4",children:[t.jsx("h3",{className:"text-lg font-semibold text-gray-900",children:r.author}),t.jsx("p",{className:"text-gray-600",children:"Skribent på Kalkylatorn.com"})]})]})}),t.jsxs("div",{className:"mt-12 p-6 bg-indigo-50 rounded-2xl",children:[t.jsx("h3",{className:"text-xl font-bold text-gray-900 mb-4",children:"Vill du lära dig mer?"}),t.jsx("p",{className:"text-gray-600 mb-4",children:"Utforska våra kalkylatorer för att planera din ekonomi, hälsa och vardag."}),t.jsx(i,{to:"/",className:"inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors",children:"Se alla kalkylatorer"})]})]})]})};export{p as BLOG_POSTS,I as default};
//# sourceMappingURL=BlogPost-Bfnerg9R.js.map
