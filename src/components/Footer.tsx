        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="mt-4 text-base text-gray-500">
              Kalkulatorn.se erbjuder gratis onlinekalkylatorer för olika vardagliga beräkningar och omvandlingar.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <a href="mailto:contact@kalkulatorn.se" className="text-base text-gray-500 hover:text-gray-900">
                  contact@kalkulatorn.se
                </a>
              </li>
            </ul>
          </div>
