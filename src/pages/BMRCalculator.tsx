...
const BMRCalculator = () => {
  ...
  const seo = calculatorSEO['/bmrkalkylator'];

  const activityLevels = [
    { level: 'sedentary' as const, factor: 1.2, title: 'Stillasittande', description: 'Ingen träning' },
    { level: 'lightActive' as const, factor: 1.375, title: 'Lätt aktiv', description: 'Träning 1-3 ggr/vecka' },
    { level: 'moderatelyActive' as const, factor: 1.55, title: 'Måttligt aktiv', description: 'Träning 3-5 ggr/vecka' },
    { level: 'veryActive' as const, factor: 1.725, title: 'Mycket aktiv', description: 'Träning 6-7 ggr/vecka' },
